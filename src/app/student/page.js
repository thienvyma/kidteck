...
export default async function StudentDashboard() {
  ...
  if (role !== 'student') {
    redirect(role === 'admin' ? '/admin' : '/account-error')
  }

  const quoteList = [
    '"Hanh trinh van dam bat dau tu mot buoc chan." — Lao Tu',
    '"Tuong lai thuoc ve nguoi hoc hoi khong ngung." — Eric Hoffer',
  ...
  name = profile?.full_name || 'Hoc sinh'
